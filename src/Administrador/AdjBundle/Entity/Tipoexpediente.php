...
/**
 * Administrador\AdjBundle\Entity\Tipoexpediente
 *
...
{
    /**
     * @var integer $tipoexpedienteId
     *
     * @ORM\Column(name="TipoExpediente_id", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $tipoexpedienteId;

    /**
     * @var string $tipoexpediente
     *
     * @ORM\Column(name="TipoExpediente", type="string", length=300, nullable=true)
     */
